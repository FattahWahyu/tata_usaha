            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    ...
                    if (!empty($this->session->userdata('email'))) { ?>
                        ...
                        <a class="nav-item nav-link active" href="<?= base_url('member/myprofil'); ?>">Profil Saya</a>
                        <a class="nav-item nav-link active" href="<?= base_url('member/logout'); ?>"><i class="fas fw fa-login"></i> Keluar</a>
                    <?php } else { ?>
                        <a class="nav-item nav-link active" data-toggle="modal" data-target="#daftarModal" href="#"><i class="fas fw fa-login"></i> Daftar</a>
                        <a class="nav-item nav-link active" data-toggle="modal" data-target="#loginModal" href="#"><i class="fas fw fa-login"></i> Masuk</a>
                    <?php } ?>
                    <span class="nav-item nav-link active nav-right" style="display:block; margin-left:20px;">Hallo! <b><?= $user; ?></b></span>
                </div>
            </div>
        </div>
    </nav>
