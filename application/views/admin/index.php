      ...
      <div class="card border-left-warning shadow h-100 py-2 bg-danger">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-md font-weight-bold text-white text-uppercase mb-1">Daftar Anggota</div>
    ...
    <!-- <div class="col-xl-4 col-md-6 mb-6">
      <div class="card border-left-primary shadow h-100 py-2 bg-info">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-md font-weight-bold text-white text-uppercase mb-1">Stok Barang Supplier</div>
            ...
            <div class="col-auto">
              <a href="<?= base_url('buku'); ?>"><i class="fas fa-cubes fa-3x text-primary"></i></a>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="col-auto col-md-6 mx-auto">
      <div class="card border-left-danger shadow h-100 py-2 bg-success">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-md font-weight-bold text-white text-uppercase mb-1">Jumlah Pembelian</div>
              <div class="h1 mb-0 font-weight-bold text-white">
                <?php
                $where = ['dibooking != 0'];
  ...
  <div class="row">
    <div class="table-responsive table-bordered col-sm-5 ml-auto mr-auto mt-2 mb-auto">
      <div class="page-header">
        <span class="fas fa-users text-danger mt-2 "> Data Anggota</span>
        <a class="text-info" href="<?php echo base_url('user/anggota'); ?>"><i class="fab fa-searchengin mt-2 float-right"> Perlihatkan</i></a>
      </div>
    ...
    <div class="table-responsive table-bordered col-sm-5 ml-auto mr-auto mt-2">
      <div class="page-header">
        <span class="fas fa-truck-loading text-primary mt-2"> Data Supplier</span>
        <a href="<?= base_url('buku'); ?>"><i class="fab fa-searchengin text-success mt-2 float-right"> Perlihatkan</i></a>
      </div>
